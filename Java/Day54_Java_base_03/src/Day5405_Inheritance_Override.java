 ...
 * 상속 : 메소드 오버라이드 (재정의)
 */
public class Day5405_Inheritance_Override {
    public static void main(String[] args) {
         ...
         * 
         */
        System.out.println("[상속 : 메소드 오버라이드(재정의)]");
        System.out.println("\n----------------------------------------\n");
        ...
        // dog 객체를 이용해서 부모의 name, age 값을 변경하기
        // - 값은 임의의 값으로
        // - 변경 후 dog 및 cat을 통해서 name과 age의 값을 출력해주세요.

        dog.setName("name의 값 변경");
        dog.setAge(11111111);
        System.out.println("dog에서 name = %s, age = %d ".formatted(dog.getName(), dog.getAge()));
        System.out.println("cat에서 name = %s, age = %d ".formatted(cat.getName(), cat.getAge()));
...
class Dog extends Animal{ 
        ...
        // 출력 메소드2(부모 클래스의 printOverride() 메소드 재정의 하기)
        @Override
        public void printOverride(){
            System.out.println("자식 클래스 ::: printOverride() 메소드 호출");
...
class Cat extends Animal{
    public void printOverride(){
        System.out.println("Cat 자식 클래스 :: printOverride() 메소드 호출");
    }
}