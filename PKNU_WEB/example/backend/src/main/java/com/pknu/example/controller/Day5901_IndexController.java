...
//                   : Rest는 Rest Api를 의미하며, 프론트엔트가 별도로 분리되었다는 의미
@RestController
public class Day5901_IndexController {
    ...
    // @GetMapping(path="/")
    // public String root2(){
    //     return "<h1>스프링부트 메인 페이지 입니다222</h1>";
    // }
    ...
    public String root3(){
        // return "<h1>스프링부트 메인 페이지 입니다333</h1>";

        // 버퍼 메모리에 문자열을 행단위로 작성하여 문자열 변수처럼 사용하는 객체
        StringBuffer sb = new StringBuffer();

        sb.append("<h1> 스프링부트 메인 페이지 입니다211111 </h1>");
        sb.append("<hr/>");
        ...
        sb.append("<tr><td>파라메터1개</td><td><a href='/param?mem_id=a001'>바로가기</a></td></tr>");
        sb.append("<tr><td>파라메터2개</td><td><a href='/param2?mem_id=a001&mem_name=홍길동'>바로가기</a></td></tr>");
        sb.append("<tr><td>회원 전체 조회</td><td><a href='/member/list'>바로가기</a></td></tr>");
        sb.append("<tr><td>회원 상세 조회</td><td><a href='/member/view'>바로가기</a></td></tr>");
        sb.append("<tr><td>회원 정보 입력</td><td><a href='/member/insert'>바로가기</a></td></tr>");
        sb.append("<tr><td>회원 정보 수정</td><td><a href='/member/update'>바로가기</a></td></tr>");
        sb.append("<tr><td>회원 정보 삭제</td><td><a href='/member/delete'>바로가기</a></td></tr>");
        sb.append("</table>");
    ...
    public String pathVariable(@PathVariable int id) {
        return "숫자 파라미터를 받아서 처리하기: " + id;
    }

    /***
     *  - 사용자 폼 데이터를 get 방식으로 전송 받을 때 사용하는 방식
     *  - https://localhost:8080/param?mem_id=a001
    ...
    public String paramVariable(@RequestParam String mem_id) {
        return "key=value 형태의 파라미터 받아서 처리 = " + mem_id;
    }

    /***
     * 요청 URL: https://localhost:8080/param2?mem_id=a001&mem_name=홍길동
     * @param mem_id
     * @return
     */
     ...
     *  - 위에 처리 후 결과값(reutrn)은 자유롭게 화면에 출력
     *  - rootURL 패턴 처리 메소드에 링크 추가
     */
